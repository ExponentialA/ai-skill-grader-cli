...
//
// Codex build: resolves a bare skill name against Codex's skill locations
// (~/.codex/skills, ~/.agents/skills, and the project's .codex/.agents dirs),
// falling back to the Claude location so it works either way.
const fs = require("fs");
const os = require("os");
